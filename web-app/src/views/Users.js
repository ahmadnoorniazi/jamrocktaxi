...
export default function Users() {
  ...
  const columns = [
      ...
      { title: language.vehicle_no, field: 'vehicleNumber'},
      ...
      { title: language.wallet_balance,  field: 'walletBalance', type:'numeric'},
      ...
      { title: language.bankCode,  field: 'bankCode'},
      { title: language.bankAccount,  field: 'bankAccount'},
